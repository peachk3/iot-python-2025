...
- 파이썬 응용
    ...
    - 파이썬 GUI 라이브러리
        1. PyQt, PySide : 파이썬 최고의 GUI 라이브러리. Qt라는 C/C++ 사용할 GUI 라이브러리를 Python용으로 변경
            ...
            - Qt가 라이선스를 구매 필수, 프리웨어로 변경 -> PySide
...
- 파이썬 응용
    - 토이프로젝트
        - ChatGPT 유사앱 - 구글 제미나이 API 사용
    - 실습
        - 제미나이 챗앱 -> **클래스 형태**로 변경

    https://github.com/user-attachments/assets/0546128d-842c-497b-9f97-d2d59bcad911
